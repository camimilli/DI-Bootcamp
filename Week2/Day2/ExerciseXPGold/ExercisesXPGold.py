...
def main()->str:
    '''
    calculates how many throws takes to reach 100 doubles
    prints number of throws and average throws to reach doubles
    '''
    throws_per_iteration = []

    for _ in range(100):
        throws_per_iteration.append(throw_until_doubles())
