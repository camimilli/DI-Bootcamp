# # this module is useful when we work with files/folders 
# # it helps us to navigate our OS (operational system)
# # for example, if you have issues with Python finding the file you're trying to read 
# # you can create a variable and use os to find the path of the file you want to manipulate
